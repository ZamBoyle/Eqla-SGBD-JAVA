...
/*     @Override
    public Object clone() {
        ...
        auteur.setId(this.getId());
        auteur.setNom(this.getNom());
        auteur.setPrenom(this.getPrenom());
        auteur.setDate_naissance(this.getDate_naissance());
        auteur.setNationalite(this.getNationalite());
        return auteur;
    } */

    @Override
    public Auteur clone() throws CloneNotSupportedException {
        return (Auteur) super.clone();
    }
