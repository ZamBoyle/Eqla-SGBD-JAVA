    ...
    public static int getValidInt(String message, Scanner scanner) {
        ...
        while (true) {
            ...
            if (scanner.hasNextInt()) {
                ...
                System.out.println("Votre saisie n'est pas un valide, veuillez réessayer.");
                scanner.next();
            }
        }
    }
 ...
 */
    ...
    public static java.time.LocalDate getValidLocalDate(String message, Scanner scanner){
        if (scanner == null)
            scanner = new Scanner(System.in);
        Date date = getValidDate(message, scanner);
        return date.toInstant().atZone(java.time.ZoneId.systemDefault()).toLocalDate();
    }

    public static java.time.LocalDate getValidLocalDate(String message){
        return getValidLocalDate(message, null);
    }
}
